...
DEFAULT_PROMPT = (
    ...
    "Nose is a small but clearly visible two-nostril mark (a short gull-wing/'w' curve), not "
    "reduced down to an invisible tick -- and a short vertical philtrum tick between the nose and "
    "the upper lip. "
