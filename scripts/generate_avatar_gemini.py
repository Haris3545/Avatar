...
DEFAULT_PROMPT = (
    ...
    "Glasses (if the subject wears them) are a bold, thick, continuous outlined frame with no gaps "
    "or breaks anywhere in the line -- noticeably thicker than the thin weight used for everything "
