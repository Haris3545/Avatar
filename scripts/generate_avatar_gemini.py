...
DEFAULT_PROMPT = (
    ...
    "enclosed outline either. Base the exact eye shape/angle on the reference avatars' style while "
    "keeping the eye positions from the structural image. "
    ...
    "continuous browline-into-glasses shape rather than two separate marks. "
    ...
    "accent weight, add one short curved smile-line beside each corner of the mouth if the photo "
    "shows the subject smiling, plus a single short accent-weight line directly below the lower "
    "lip separating the chin from the lip. "
    "These few accent marks are the ONLY extra detail permitted anywhere in the face -- do not add "
    "any other marks, texture, or shading beyond them. Also add one short accent-weight fold line "
    "inside each visible ear, echoing its natural curve. "
